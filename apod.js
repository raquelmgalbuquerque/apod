...
window.onload = () => {
  ...
  displayApod("today");
  // ... and block the input maximum to today's date.
  todayDate();
  displayRandomApods();
};
...
// =====================================================================
// This is the backup plan when I do too many API requests
// =====================================================================
// const apiData = [
//   {
...
// function displayRandomApods() {
//   // Lets sort the random pictures by date
//   let apods = apiData;
//   //   .map((obj) => {
...
//   let randomApodContainer = document.querySelector(".random-apod-container");
